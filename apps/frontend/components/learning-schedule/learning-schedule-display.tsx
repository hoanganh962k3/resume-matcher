								...
								>
									{expanded ? (
										...
										<>
											...
											Show {activity.resources.length} Resource{activity.resources.length > 1 ? 's' : ''}
										</>
									)}
								</button>
			...
			<div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 rounded-lg p-6 border border-purple-500/30">
				...
				<div className="grid md:grid-cols-3 gap-4 mb-4">
					<div className="bg-gray-900/50 rounded p-4 border border-gray-700">
						...
						<div className="text-lg font-semibold text-white capitalize">{scheduleData.scheduleType}</div>
					</div>
					<div className="bg-gray-900/50 rounded p-4 border border-gray-700">
						<div className="text-sm text-gray-400 mb-1">Duration</div>
						<div className="text-lg font-semibold text-white">{scheduleData.totalDurationWeeks} weeks</div>
					</div>
					<div className="bg-gray-900/50 rounded p-4 border border-gray-700">
						<div className="text-sm text-gray-400 mb-1">Time Commitment</div>
						<div className="text-lg font-semibold text-white">{scheduleData.overview.estimatedTimePerWeek}</div>
					</div>
				</div>
