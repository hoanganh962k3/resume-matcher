...
import BackgroundContainer from '@/app/components/common/background-container';
import InsightsPanel from '@/app/components/dashboard/job-listings';
import ResumeAnalysis from '@/app/components/dashboard/resume-analysis';
import Resume from '@/app/components/dashboard/resume-component'; // rename import to match default export
import { useResumePreview } from '@/app/components/common/resume_previewer_context';
